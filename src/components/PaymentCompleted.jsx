...
function PaymentCompleted() {
  ...
  const order = JSON.parse(localStorage.getItem("customerDetails"));
  ...
  return (
    <div className="oc-wrap">
      ...
      <p className="oc-note">
        ...
        information can be found on the attached receipt. Your receipt and order
      ...
      <section className="oc-bank">
        ...
        <p>
          {bank.particularsHintPrefix} <strong>{order.id}</strong>.
          <br />
      ...
      <section className="oc-form">
        <form onSubmit={onSubmitContact} className="oc-form-grid">
          ...
          <div className="oc-field">
            ...
            <input id="lastName" name="lastName" defaultValue="abc" required />
          </div>

          <label className="oc-check">
            <input type="checkbox" name="newsletter" /> I would like to receive
            email newsletters and Academic Award information -
          </label>
